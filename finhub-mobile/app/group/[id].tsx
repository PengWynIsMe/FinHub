...
// ─── 1. Bổ sung 'route' vào cấu trúc dữ liệu ──────────────────────────────
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => router.push({
            ...
            params: { name: name } // Truyền tên nhóm sang để hiển thị trên Header
          })}
        >
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {MANAGEMENT_MENUS.map((menu) => (
          <TouchableOpacity 
            ...
            activeOpacity={0.8}
            onPress={() => {
              // ─── 2. GỌN GÀNG: Chỉ cần 1 dòng này thay vì đống IF/ELSE ───
              if (menu.route) {
                // @ts-ignore - Bỏ qua cảnh báo type strict của expo-router tạm thời
